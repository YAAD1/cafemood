...
class Sicak extends StatelessWidget {
  final List<KahveTarifi> sicakTarifler = [
    ...
    KahveTarifi(
        ...
        1),
    KahveTarifi('Mocha', 'Sıcak Tarif 4 İçeriği', 'b', 'lib/images/mocha.jpg',
    ...
    KahveTarifi(
        ...
        1),
    KahveTarifi('Latte', 'Sıcak Tarif 6 İçeriği', 'b', 'lib/images/latte.jpg',
        'https://www.example.com/soguk-tarif-1-playlist', 1),
    KahveTarifi('Caramel Mocha', 'İçerik ', 'b', 'lib/images/caramel-mocha.jpg',
        'https://www.example.com/soguk-tarif-1-playlist', 2),
    KahveTarifi(
        'Türk Kahvesi', 'icerik', 'b', 'lib/images/turk-kahvesi.jpg', 'url', 3),
    KahveTarifi(
        'Pumpkin Spice ', 'b', 'icerik', 'lib/images/pumpkin.jpg', 'url', 3)
  ];
