          ...
          IconButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                context,
                PageRouteBuilder(
                  pageBuilder: (_, __, ___) => KahveTarifiSayfasi(sicakTarifler[randomIndex]),
          ...
          return InkWell(
            ...
            onTap: () { 
              Navigator.push(
                context,
                PageRouteBuilder(
                  pageBuilder: (_, __, ___) => KahveTarifiSayfasi(sicakTarifler[index]),
                  transitionsBuilder: (_, animation, __, child) {
                    return ScaleTransition(
                      scale: animation,
                      child: child,
          ...
          return InkWell(
            ...
            onTap: () { 
              Navigator.push(
                context,
                PageRouteBuilder(
                  pageBuilder: (_, __, ___) => KahveTarifiSayfasi(sogukTarifler[index]),
                  transitionsBuilder: (_, animation, __, child) {
                    return ScaleTransition(
                      scale: animation,
                      child: child,
